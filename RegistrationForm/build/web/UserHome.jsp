<%-- 
    Document   : UserHome
    Created on : 20-Jul-2023, 2:42:51 pm
    Author     : Nivedha.S
--%>
                ...
                <div id="slider" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="img-fluid" src="img/slider1.jpg" alt="Slide 1">
                        </div>
                        <div class="carousel-item">
                           <img class="img-fluid" src="img/slider2.jpg" alt="Slide 2">
                        </div>
                        <div class="carousel-item">
                           <img class="img-fluid" src="img/slider3.jpg" alt="Slide 3">
                        </div>
