    ...
    <body>
        ...
        <div class="container-fluid pt-5">
            <div class="container">
                ...
                <table id="sabari" style="margin: auto;padding: 10px;">
                    <tr>
                        <th>Id</th>
                        <th>File Name</th>
                        <th>Description</th>
                    ...
                    <tr>
                        ...
                        <td><%=rs.getString("fdes")%></td>
                        <td><%=rs.getString("dkey")%></td>
                        <td><%=rs.getString("ftime")%></td>
                        <td><a href="Fdownload.jsp?fid=<%=rs.getString("id")%>&fname=<%=rs.getString("fname")%>" target="_blank"  class="btn btn-success" style="color: white">&nbsp;View</a></td>
                    </tr>
                    <%                                        }
                            rs.close();
                        } catch (Exception ex) {
